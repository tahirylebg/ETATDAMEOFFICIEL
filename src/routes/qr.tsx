        ...
        <section className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] print:block">
          <div className="print:hidden">
            ...
            <p className="mt-5 max-w-xl leading-relaxed text-cocoa/78">
              Chaque QR ouvre la carte digitale avec accès direct aux infos pratiques et à la
              réservation. Mets l'URL publique finale du site, puis imprime les supports de table.
            </p>
